                        ...
                        <form  method="POST" action="cart.php">
                            <div class="table_page table-responsive">
                                <table>
                                    ...
                                    $i=0;
                                        $total_sp=$item['price']*$item['sl'];
                                    
                                    ?>
                                        <!-- Start Cart Single Item-->
                                        <tr>
                                            <td class="product_remove"><a href=xoa-cart.php?id=<?php echo $i?>><i class="fa fa-trash-o"></i></a>
                                            <td class="product_thumb"><a href="product-details-default.html"><img
                                                        src="img_sp/<?php echo $item['img']?>.jpg"
                                                        alt=""></a></td>
                                            <td class="product_name"><a href="product-details-default.html"><?php echo $item['ten_sp']?></td>
                                            <td class="product-price"><?php echo currency_format($item['price'])?></td>
                                            <td class="product_quantity"><label>Số Lượng</label> <input  name="qrt" min="1"
                                                    max="100" value="<?php echo $item['sl']?>" type="number"></td>
                                            <td class="product_total"><?php echo currency_format($total_sp)?></td>
                                        </tr> 
                                    <?php }?><!-- End Cart Single Item-->
                                    </tbody>
                                </table>
                            </div>
                        
                                <div class="cart_submit">
                                    <button class="btn btn-md btn-golden" type="submit">cập nhập giỏ hàng</button>
                                </div>
                            </form>
                    ...
                    <div class="col-lg-6 col-md-6">
                        <div class="coupon_code left" data-aos="fade-up" data-aos-delay="200">
                            ...
                            <div class="coupon_inner">
                                ...
                                <input class="mb-2" placeholder="Mã phiếu giảm giá" type="text">
                        ...
                        <div class="coupon_code right" data-aos="fade-up" data-aos-delay="400">
                            ...
                            <div class="coupon_inner">
                                <div class="cart_subtotal">
                                    <p>Tổng Tiền Hàng</p>
                                    <p class="cart_amount"><?php echo $total_money?></p>
                                </div>
                                <div class="cart_subtotal ">
                                    <p>Phí Vận Chuyển</p>
                                    <p class="cart_amount">0d</p>
                                </div>
                                ...
                                <div class="checkout_btn">
                                    <a href="#" class="btn btn-md btn-golden">Tiến Hành Thanh Toán</a>
                                </div>
                            </div>
                        </div>
                    </div>

                        ...
                        <div class="product-large-image product-large-image-horaizontal swiper-container">
                            <div class="swiper-wrapper">
                                <div class="product-image-large-image swiper-slide zoom-image-hover img-responsive">
                                    <img src="img_sp/<?php echo $chi_tiet['img_sp']?>.jpg" alt="">
                                </div>
                                <div class="product-image-large-image swiper-slide zoom-image-hover img-responsive">
                                    <img src="img_sp/<?php echo $chi_tiet['img_sp2']?>.jpg" alt="">
                                </div>
                                <div class="product-image-large-image swiper-slide zoom-image-hover img-responsive">
                ...
                <div class="col-xl-7 col-lg-6">
                    <div class="product-details-content-area product-details--golden" data-aos="fade-up"
                        ...
                        <div class="product-details-text">
                            <h4 class="title"><?php echo $chi_tiet['ten_sp']?></h4>

                            <div class="price"><?php echo currency_format($chi_tiet['gia'])?></div>
                            ...
                            <div class="d-flex align-items-center ">
                                ...
                                <form method="post" action="add-to-card.php">
                                    <div class="product-add-to-cart-btn">
                                        <input type="hidden" name="id" value="<?php echo $chi_tiet['ma_sp']?>">
                                        <input name="addtocart" type="submit" class="btn btn-block btn-lg btn-black-default-hover"
                                            data-bs-toggle="modal" data-bs-target="#modalAddcart" value="Thêm Vào Giỏ Hàng"></input>
                                    </div>
                                </form>
                            </div>
